...
local default = {
  ...
  lsp = {
    ...
    disable_lsp = {'pylsd', 'sqlls', 'ngserver', 'vscode-html-language-server'}, -- a list of lsp server disabled for your project, e.g. denols and tsserver you may
