-- Credits to https://github.com/LunarVim/LunarVim/blob/rolling/lua/lvim/core/log.lua
local Log = {}
...
function Log:init()
  ...
  local log_level = Log.levels[(MrGeek.log.level):upper() or 'WARN']
  ...
  structlog.configure(mrgeek_log)
...
function Log:get_path()
  return string.format('%s/%s.log', get_home_dir(), 'mrgeek')
end
